...
const SEED_EQUIPMENT_BASE = [
  ...
  { id: "naut-2st-vert-chest", name: "Nautilus 2ST Vertical Chest Press", brand: "Nautilus", category: "Chest", subcategory: "Presses", cost: 1000, marketValue: 2750, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Manassas, VA" },
  { id: "naut-xpload-incline", name: "Nautilus Xpload Incline Press", brand: "Nautilus", category: "Chest", subcategory: "Presses", cost: 5000, marketValue: 7000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Greenville, SC" },
  { id: "naut-1stgen-bench-iii", name: "Nautilus 1st Gen Bench Press III", brand: "Nautilus", category: "Chest", subcategory: "Presses", tdmRef: "277", cost: 1200, marketValue: 2000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "Belmont, NC" },
  { id: "megamass-lev-incline", name: "Megamass Leverage Incline Press", brand: "Megamass", category: "Chest", subcategory: "Presses", tdmRef: "261", cost: 2995, marketValue: 4500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", seller: "Belfast" },
  { id: "magnum-biangular-chest", name: "Magnum Biangular Chest", brand: "Magnum", category: "Chest", subcategory: "Presses", tdmRef: "151", cost: 1500, marketValue: 2250, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "Bellevue, IL", notes: "Metal plate needed both sides top of stack tower + green globe on stack casing" },
  { id: "magnum-biangular-upper-chest", name: "Magnum Biangular Upper Chest", brand: "Magnum", category: "Chest", subcategory: "Presses", cost: 1700, marketValue: 2000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Bellevue, IL" },
  { id: "atlantis-converging-incline", name: "Atlantis Converging Incline Press", brand: "Atlantis", category: "Chest", subcategory: "Presses", tdmRef: "101", cost: 4700, marketValue: 5000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "Laval, Quebec" },
  { id: "icarian-incline-bench", name: "Icarian Incline Bench Press", brand: "Icarian", category: "Chest", subcategory: "Presses", tdmRef: "317", cost: 250, marketValue: 1000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", notes: "Needs Icarian stickers (NOT Precor)" },

  // ===== PEC DECS =====
  { id: "flex-deltoid-fly", name: "Flex Fitness Deltoid Fly", brand: "Flex Fitness", category: "Chest", subcategory: "Pec Decs / Flies", tdmRef: "270", cost: 2500, marketValue: 3000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", returnDate: "2026-07-17", seller: "Baltimore, MD" },
  { id: "paramount-pec-fly-ap3400", name: "Paramount Pec Fly Rear Delt AP3400", brand: "Paramount", category: "Chest", subcategory: "Pec Decs / Flies", tdmRef: "320", cost: 2000, marketValue: 3500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", returnDate: "2026-07-09" },
  { id: "naut-1stgen-10-fly", name: "Nautilus 1st Gen 10 Degree Fly", brand: "Nautilus", category: "Chest", subcategory: "Pec Decs / Flies", tdmRef: "284", cost: 3300, marketValue: 5000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", returnDate: "2026-07-10", seller: "Indiana, IN" },
  { id: "arsenal-reloaded-incline-fly", name: "Arsenal Reloaded Incline Fly", brand: "Arsenal", category: "Chest", subcategory: "Pec Decs / Flies", tdmRef: "244", cost: 3300, marketValue: 4000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "Knoxville, TN" },
  { id: "naut-nitro-pec-fly-rear-delt", name: "Nautilus Nitro Pec Fly / Rear Delt", brand: "Nautilus", category: "Chest", subcategory: "Pec Decs / Flies", cost: 2000, marketValue: 2700, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Wrexham", notes: "Make a rear plate" },
  { id: "bodymasters-pec-fly-rear-delt", name: "Bodymasters Pec Fly / Rear Delt", brand: "Bodymasters", category: "Chest", subcategory: "Pec Decs / Flies", cost: 1200, marketValue: 3200, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Morelia" },
  { id: "cybex-galileo-chest-press", name: "Cybex Galileo Chest Press", brand: "Cybex", category: "Chest", subcategory: "Presses", tdmRef: "368", cost: 1000, marketValue: 2000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Refurb", notes: "Deliver to JP then back to us 20/7" },

  // ===== SHOULDER PRESSES =====
  { id: "naut-2st-shoulder-press", name: "Nautilus 2ST Shoulder Press", brand: "Nautilus", category: "Shoulders", subcategory: "Presses", cost: 1500, marketValue: 2500, currentLocation: "At Nytram", destination: "For Sale", status: "In Refurb", refurbStage: "Refurb", refurbisher: "Nytram", returnDate: "2026-07-10", seller: "Moxee, WA" },
  { id: "gymleco-shoulder-030", name: "Gymleco Shoulder Press 030", brand: "Gymleco", category: "Shoulders", subcategory: "Presses", tdmRef: "282", cost: 3450, marketValue: 3450, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", seller: "Eskilstuna" },
  { id: "flex-leverage-shoulder", name: "Flex Fitness Leverage Shoulder Press", brand: "Flex Fitness", category: "Shoulders", subcategory: "Presses", tdmRef: "200", cost: 4000, marketValue: 4500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "Moncton" },
  { id: "atlantis-converging-shoulder", name: "Atlantis Converging Shoulder Press", brand: "Atlantis", category: "Shoulders", subcategory: "Presses", tdmRef: "102", cost: 4700, marketValue: 5000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "Laval, Quebec" },

  // ===== LATERAL RAISES =====
  { id: "megamass-chain-lateral", name: "Megamass Chain Driven Lateral Raise", brand: "Megamass", category: "Shoulders", subcategory: "Laterals", tdmRef: "260", cost: 2995, marketValue: 3700, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "Dezhou" },
  { id: "flex-deltoid-raise", name: "Flex Fitness Deltoid Raise", brand: "Flex Fitness", category: "Shoulders", subcategory: "Laterals", tdmRef: "173", cost: 3000, marketValue: 3250, currentLocation: "At Nytram", destination: "Unity Lichfield", status: "In Use", refurbStage: "Refurb", refurbisher: "Nytram", seller: "Florence" },
  { id: "bodymasters-321-lateral", name: "Bodymasters 321 Lateral Raise", brand: "Bodymasters", category: "Shoulders", subcategory: "Laterals", tdmRef: "309", cost: 2500, marketValue: 3500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Complete", deliveryDate: "2026-07-10", returnDate: "2026-07-24", seller: "Johnston, RI" },
  { id: "cybex-eagle-lateral", name: "Cybex Classic Eagle Lateral Raise", brand: "Cybex", category: "Shoulders", subcategory: "Laterals", tdmRef: "281", cost: 2200, marketValue: 3500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", returnDate: "2026-07-10", seller: "Longview, TX" },
  { id: "arsenal-standing-lateral", name: "Arsenal Standing Lateral Raise", brand: "Arsenal", category: "Shoulders", subcategory: "Laterals", tdmRef: "240", cost: 3300, marketValue: 4250, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", returnDate: "2026-07-17", seller: "Santa Ana, CA" },
  { id: "strive-lateral-raise", name: "Strive Lateral Raise", brand: "Strive", category: "Shoulders", subcategory: "Laterals", cost: 3000, marketValue: 4000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Guadalajara" },
  { id: "lf-pro1-lateral", name: "Life Fitness Pro 1 Lateral Raise", brand: "Life Fitness", category: "Shoulders", subcategory: "Laterals", cost: 1300, marketValue: 1500, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Southampton", notes: "Make a stack casing" },

  // ===== PULLDOWNS =====
  { id: "precor-pulldown", name: "Precor Pulldown", brand: "Precor", category: "Back", subcategory: "Pulldowns", cost: 0, marketValue: 750, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Lichfield" },
  { id: "hd-xpload-pulldown", name: "HD (Xpload) Pulldown", brand: "HD", category: "Back", subcategory: "Pulldowns", cost: 1800, marketValue: 2200, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Stockport" },
  { id: "strive-pl-pulldown", name: "Strive PL Pulldown", brand: "Strive", category: "Back", subcategory: "Pulldowns", tdmRef: "175", cost: 5500, marketValue: 7500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "Winnipeg" },
  ...
  { id: "granite-lev-pulldown", name: "Granite Leverage Pulldown 2.0", brand: "Granite", category: "Back", subcategory: "Pulldowns", tdmRef: "321", cost: 2700, marketValue: 3000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Refurb", notes: "Deliver to JP then back 24/7. Custom sticker where Flex Leverage would normally go" },
  { id: "hoist-star-pulldown", name: "Hoist Star Pulldown", brand: "Hoist", category: "Back", subcategory: "Pulldowns", tdmRef: "191", cost: 1000, marketValue: 2500, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Redditch", notes: "Remake info plate both sides + period-correct Hoist logo" },
  { id: "cybex-vr2-pulldown", name: "Cybex VR2 Pulldown", brand: "Cybex", category: "Back", subcategory: "Pulldowns", tdmRef: "236", cost: 2000, marketValue: 3500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "Redgranite, WI" },
  { id: "cybex-eagle-incline-pull", name: "Cybex Eagle Incline Pull", brand: "Cybex", category: "Back", subcategory: "Pulldowns", cost: 1000, marketValue: 1500, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Wrexham" },

  // ===== ROWS =====
  { id: "megamass-tbar-linear-row", name: "Megamass T Bar Linear Row", brand: "Megamass", category: "Back", subcategory: "Rows", tdmRef: "258", cost: 2995, marketValue: 4000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "Belfast" },
  { id: "megamass-45-iso-row-pro", name: "Megamass 45 Degree Iso Linear Row Pro", brand: "Megamass", category: "Back", subcategory: "Rows", tdmRef: "261", cost: 4195, marketValue: 5500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "Belfast" },
  { id: "cybex-classic-row", name: "Cybex Classic Row (VR2)", brand: "Cybex", category: "Back", subcategory: "Rows", cost: 770, marketValue: 3500, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Jackson, MS" },
  { id: "flex-lev-row", name: "Flex Fitness Leverage Row", brand: "Flex Fitness", category: "Back", subcategory: "Rows", tdmRef: "333", cost: 6300, marketValue: 9000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", arrivalDate: "2026-07-23", notes: "ETA 23rd July. Deliver to Craig 24/7" },
  { id: "flex-dorsiflexor", name: "Flex Fitness Dorsiflexor", brand: "Flex Fitness", category: "Back", subcategory: "Rows", tdmRef: "255", cost: 2850, marketValue: 3250, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", seller: "Durango" },
  { id: "panatta-fantastic-row", name: "Panatta Fantastic Chain-Driven Row", brand: "Panatta", category: "Back", subcategory: "Rows", cost: 500, marketValue: 1200, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Leeds" },
  { id: "hd-magnum-biangular-row", name: "HD (Magnum) Biangular Row", brand: "HD", category: "Back", subcategory: "Rows", cost: 1650, marketValue: 2000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Stockport" },
  { id: "bodymasters-tbar-row", name: "Bodymasters T Bar Row", brand: "Bodymasters", category: "Back", subcategory: "Rows", tdmRef: "310", cost: 2500, marketValue: 3000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "Wrexham" },
  { id: "strive-pl-extreme-row", name: "Strive PL Extreme Row", brand: "Strive", category: "Back", subcategory: "Rows", tdmRef: "176", cost: 3000, marketValue: 6000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "Wroclaw" },
  { id: "prime-pl-seated-row", name: "Prime PL Seated Row", brand: "Prime", category: "Back", subcategory: "Rows", tdmRef: "190", cost: 1900, marketValue: 3500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", arrivalDate: "2026-07-23", seller: "Franklin, PA" },
  { id: "hs-iso-row", name: "Hammer Strength Iso Row", brand: "Hammer Strength", category: "Back", subcategory: "Rows", cost: 1600, marketValue: 1800, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Magnolia, TX" },

  // ===== BACK OTHER =====
  { id: "booty-back-ext", name: "Booty Builder Back Extension", brand: "Booty Builder", category: "Back", subcategory: "Back Ext", tdmRef: "221", cost: 4025, marketValue: 4500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "London", notes: "3D gel text logo + info plate" },
  { id: "naut-nitro-back-ext", name: "Nautilus Nitro Back Extension", brand: "Nautilus", category: "Back", subcategory: "Back Ext", cost: 550, marketValue: 550, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Wrexham" },
  { id: "naut-super-pullover-ii", name: "Nautilus Super Pullover II", brand: "Nautilus", category: "Back", subcategory: "Pullover", tdmRef: "272", cost: 3250, marketValue: 5000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", returnDate: "2026-07-10", seller: "Reynoldsville, PA" },
  { id: "naut-nitro-pullover", name: "Nautilus Nitro Pullover", brand: "Nautilus", category: "Back", subcategory: "Pullover", cost: 2000, marketValue: 3500, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Laredo, TX" },
  { id: "hs-pullover", name: "Hammer Strength Pullover", brand: "Hammer Strength", category: "Back", subcategory: "Pullover", cost: 1600, marketValue: 1800, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Harrogate" },

  // ===== LEG COMPOUNDS =====
  { id: "cybex-v1-leg-press", name: "Cybex V1 Leg Press", brand: "Cybex", category: "Legs", subcategory: "Compounds", cost: 4200, marketValue: 6000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Bellevue, IL" },
  { id: "cybex-v1-squat-press", name: "Cybex V1 Squat Press", brand: "Cybex", category: "Legs", subcategory: "Compounds", cost: 6000, marketValue: 7000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Bellevue, IL", notes: "Big sticker both sides as on Cybex leg press" },
  { id: "cybex-v1-hack", name: "Cybex V1 Hack Squat", brand: "Cybex", category: "Legs", subcategory: "Compounds", tdmRef: "132", cost: 5500, marketValue: 8000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Bellevue, IL" },
  ...
  { id: "atlantis-precision-lp", name: "Atlantis Precision Leg Press", brand: "Atlantis", category: "Legs", subcategory: "Compounds", cost: 3500, marketValue: 4000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Wrexham" },
  { id: "atlantis-pendulum-squat", name: "Atlantis Pendulum Squat", brand: "Atlantis", category: "Legs", subcategory: "Compounds", tdmRef: "103", cost: 7100, marketValue: 8000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "Laval, Quebec" },
  { id: "flex-thighsolator", name: "Flex Fitness Thighsolator", brand: "Flex Fitness", category: "Legs", subcategory: "Adductors", tdmRef: "140", cost: 3000, marketValue: 3750, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", returnDate: "2026-07-10", seller: "Detroit, MI" },
  { id: "icarian-lying-lp", name: "Icarian Lying Leg Press", brand: "Icarian", category: "Legs", subcategory: "Compounds", cost: 1500, marketValue: 2500, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Albuquerque, NM" },
  { id: "tru-squat", name: "Tru Squat", brand: "Tru Squat", category: "Legs", subcategory: "Compounds", tdmRef: "219", cost: 6000, marketValue: 7000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", seller: "Wheeling, IL", notes: "Tru Squat vertical sticker on front" },
  ...
  { id: "bodymasters-cx109-lying-curl", name: "Bodymasters CX109 Super Lying Leg Curl", brand: "Bodymasters", category: "Legs", subcategory: "Leg Curls", tdmRef: "160", cost: 3500, marketValue: 7000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", returnDate: "2026-07-15", seller: "Tucson, AZ" },
  ...
  { id: "strive-smart-prone-lc", name: "Strive Smart Strength Prone Leg Curl", brand: "Strive", category: "Legs", subcategory: "Leg Curls", tdmRef: "251", cost: 2500, marketValue: 3500, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Walsall" },
  { id: "hoist-rocit-lc", name: "Hoist Roc-It Leg Curl", brand: "Hoist", category: "Legs", subcategory: "Leg Curls", cost: 1900, marketValue: 2250, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Rochester, MN" },
  { id: "atlantis-precision-lying-lc", name: "Atlantis Precision Lying Leg Curl", brand: "Atlantis", category: "Legs", subcategory: "Leg Curls", cost: 2000, marketValue: 2000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Boise, ID" },
  { id: "atlantis-precision-seated-lc", name: "Atlantis Precision Seated Leg Curl", brand: "Atlantis", category: "Legs", subcategory: "Leg Curls", cost: 2000, marketValue: 2000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Boise, ID" },

  // ===== LEG EXTENSIONS =====
  { id: "prime-pl-leg-ext", name: "Prime PL Leg Extension", brand: "Prime", category: "Legs", subcategory: "Leg Extensions", tdmRef: "183", cost: 3800, marketValue: 4500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", arrivalDate: "2026-07-23", seller: "Franklin, PA" },
  { id: "magnum-leg-ext", name: "Magnum Leg Extension", brand: "Magnum", category: "Legs", subcategory: "Leg Extensions", cost: 0, marketValue: 0, currentLocation: "At JP", destination: "TDM Gym", status: "In Use", refurbStage: "Refurb", refurbisher: "JP", returnDate: "2026-07-15" },
  { id: "bodymasters-cx109-leg-ext", name: "Bodymasters CX109 Super Leg Extension", brand: "Bodymasters", category: "Legs", subcategory: "Leg Extensions", tdmRef: "159", cost: 3500, marketValue: 7000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", returnDate: "2026-07-09", seller: "Tucson, AZ" },
  { id: "flex-leg-ext", name: "Flex Fitness Leg Extension", brand: "Flex Fitness", category: "Legs", subcategory: "Leg Extensions", tdmRef: "124", cost: 3400, marketValue: 4500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "Tokyo" },
  { id: "cybex-vr-leg-ext", name: "Cybex VR Leg Extension", brand: "Cybex", category: "Legs", subcategory: "Leg Extensions", cost: 750, marketValue: 2000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Oxford" },
  { id: "strive-smart-leg-ext", name: "Strive Smart Strength Leg Extension", brand: "Strive", category: "Legs", subcategory: "Leg Extensions", cost: 3100, marketValue: 3600, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Walsall" },

  // ===== LEG OTHER =====
  { id: "naut-nitro-ab-ad", name: "Nautilus Nitro Ab/Adductor", brand: "Nautilus", category: "Legs", subcategory: "Adductors", cost: 2000, marketValue: 2250, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Tucson, AZ" },
  { id: "flex-classic-adductor", name: "Flex Fitness Classic Adductor", brand: "Flex Fitness", category: "Legs", subcategory: "Adductors", cost: 0, marketValue: 0, currentLocation: "At JP", destination: "Undecided", status: "In Refurb", refurbStage: "Refurb", refurbisher: "JP", returnDate: "2026-06-03" },
  { id: "granite-glutinator", name: "Granite Glutinator", brand: "Granite", category: "Legs", subcategory: "Glutes / Hips", tdmRef: "322", cost: 2800, marketValue: 3000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Refurb", notes: "Deliver to JP then back 24/7" },
  { id: "prime-hybrid-inner-thigh", name: "Prime Hybrid Inner Thigh", brand: "Prime", category: "Legs", subcategory: "Adductors", tdmRef: "181", cost: 4500, marketValue: 6000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", arrivalDate: "2026-07-23", seller: "Franklin, PA" },
  { id: "booty-v8-hip-thrust", name: "Booty Builder V8 Hip Thrust", brand: "Booty Builder", category: "Legs", subcategory: "Glutes / Hips", tdmRef: "222", cost: 4435, marketValue: 5500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "London", notes: "3D gel text logo + BB sticker + info plate" },
  { id: "naut-glute-drive", name: "Nautilus Glute Drive", brand: "Nautilus", category: "Legs", subcategory: "Glutes / Hips", cost: 2300, marketValue: 3500, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Leicester" },
  { id: "cybex-vr2-rotary-calf", name: "Cybex VR2 Rotary Calf", brand: "Cybex", category: "Legs", subcategory: "Calves", cost: 1700, marketValue: 2000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Lincoln, NE" },
  { id: "bodymasters-standing-calf", name: "Bodymasters Standing Calf", brand: "Bodymasters", category: "Legs", subcategory: "Calves", cost: 1500, marketValue: 2000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Portland, OR" },

  // ===== TRICEPS =====
  { id: "bodymasters-overhead-tri", name: "Bodymasters Overhead Tricep", brand: "Bodymasters", category: "Arms", subcategory: "Triceps", cost: 3000, marketValue: 4000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Madison, WI" },
  { id: "paramount-fw500-tri-ext", name: "Paramount FW500 Tricep Extension", brand: "Paramount", category: "Arms", subcategory: "Triceps", tdmRef: "268", cost: 3200, marketValue: 4000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", returnDate: "2026-07-17", seller: "Edmonton" },
  { id: "arsenal-overhead-tri", name: "Arsenal Overhead Tricep", brand: "Arsenal", category: "Arms", subcategory: "Triceps", tdmRef: "242", cost: 5700, marketValue: 6000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "Knoxville, TN" },
  { id: "strive-tri-ext", name: "Strive Tricep Extension", brand: "Strive", category: "Arms", subcategory: "Triceps", tdmRef: "243", cost: 2700, marketValue: 3500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", seller: "Conway, AK" },
  { id: "flex-dip-machine", name: "Flex Fitness Dip Machine", brand: "Flex Fitness", category: "Arms", subcategory: "Triceps", tdmRef: "269", cost: 2500, marketValue: 3000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", returnDate: "2026-07-17", seller: "Cheyenne, WY" },
  { id: "naut-1stgen-tri-ext", name: "Nautilus 1st Gen Tricep Extension", brand: "Nautilus", category: "Arms", subcategory: "Triceps", tdmRef: "366", cost: 1350, marketValue: 2500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Complete", deliveryDate: "2026-07-17", returnDate: "2026-07-24", seller: "Cardiff, Wales" },
  { id: "naut-nitro-sa-tri", name: "Nautilus Nitro SA Tricep Extension", brand: "Nautilus", category: "Arms", subcategory: "Triceps", cost: 1100, marketValue: 2000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Wrexham" },

  // ===== BICEPS =====
  { id: "naut-nitro-sa-bicep", name: "Nautilus Nitro SA Bicep Curl", brand: "Nautilus", category: "Arms", subcategory: "Biceps", cost: 2000, marketValue: 2250, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Wrexham" },
  { id: "naut-1stgen-bicep", name: "Nautilus 1st Gen Bicep Curl", brand: "Nautilus", category: "Arms", subcategory: "Biceps", tdmRef: "283", cost: 3000, marketValue: 5000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", returnDate: "2026-07-10", seller: "Indiana, PA" },
  { id: "hoist-rocit-cable-curl", name: "Hoist Roc-It Cable Curl", brand: "Hoist", category: "Arms", subcategory: "Biceps", cost: 1800, marketValue: 2400, currentLocation: "At Nytram", destination: "For Sale", status: "In Refurb", refurbStage: "Refurb", refurbisher: "Nytram", returnDate: "2026-07-10", seller: "Birmingham, AL" },
  { id: "flex-bisolator", name: "Flex Fitness Bisolator", brand: "Flex Fitness", category: "Arms", subcategory: "Biceps", cost: 4000, marketValue: 6500, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Tokyo" },
  { id: "strive-pl-preacher", name: "Strive PL Preacher Curl", brand: "Strive", category: "Arms", subcategory: "Biceps", cost: 2700, marketValue: 3750, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Salt Lake City, UT" },
  { id: "magnum-bicep-curl", name: "Magnum Bicep Curl", brand: "Magnum", category: "Arms", subcategory: "Biceps", tdmRef: "139", cost: 1500, marketValue: 2000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", refurbStage: "Landed", seller: "Bellevue, IL" },
  { id: "bodymasters-selectorised-bicep", name: "Bodymasters Selectorised Bicep Curl", brand: "Bodymasters", category: "Arms", subcategory: "Biceps", cost: 1400, marketValue: 2000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Brooklyn, NY" },
  ...
  { id: "lf-cable-crossover", name: "Life Fitness Older Cable Crossover", brand: "Life Fitness", category: "Other", subcategory: "Other", cost: 575, marketValue: 2600, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed" },
  { id: "lf-mj8-jungle", name: "Life Fitness MJ8 Jungle Gym", brand: "Life Fitness", category: "Other", subcategory: "Other", cost: 7500, marketValue: 8000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Redditch" },
  { id: "cybex-bravo", name: "Cybex Bravo", brand: "Cybex", category: "Other", subcategory: "Other", cost: 5500, marketValue: 5500, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Bristol" },
  ...
  { id: "cybex-v2-smith", name: "Cybex V2 Smith Machine", brand: "Cybex", category: "Powerlifting", subcategory: "Racks", cost: 2200, marketValue: 3000, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Bristol" },
  { id: "naut-smith", name: "Nautilus Smith Machine", brand: "Nautilus", category: "Powerlifting", subcategory: "Racks", cost: 1900, marketValue: 2250, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Wrexham" },
  { id: "naut-nitro-ab-crunch", name: "Nautilus Nitro Ab Crunch", brand: "Nautilus", category: "Other", subcategory: "Other", cost: 1200, marketValue: 1200, currentLocation: "WBAK HQ", destination: "For Sale", status: "In Refurb", refurbStage: "Landed", seller: "Wrexham" },
  ...
  { id: "tdm-flex-classic-incline", name: "Flex Fitness Classic Incline Press", brand: "Flex Fitness", category: "Chest", subcategory: "Presses", cost: 3000, marketValue: 0, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", notes: "Bought from Paul, paid in cash" },
  { id: "tdm-paramount-rotary-chest", name: "Paramount Rotary Chest Press", brand: "Paramount", category: "Chest", subcategory: "Presses", cost: 1550, marketValue: 0, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", notes: "Bought from Gainz, paid in cash" },
  ...
  { id: "tdm-bull-strong-belt-squat", name: "Bull Strong Belt Squat", brand: "Bull Strong", category: "Legs", subcategory: "Compounds", cost: 0, marketValue: 0, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", notes: "Acquired from Bull Strong, no fee" },
  { id: "tdm-rogue-platform", name: "Rogue Deadlift Platform + 12 Mats", brand: "Rogue", category: "Powerlifting", subcategory: "Platforms", cost: 1100, marketValue: 0, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use" },
  { id: "tdm-lf-preacher-curl", name: "Life Fitness Preacher Curl", brand: "Life Fitness", category: "Arms", subcategory: "Biceps", cost: 1140, marketValue: 0, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use" },
  { id: "tdm-naut-nitro-v-tri", name: "Nautilus Nitro V-Triceps Extension", brand: "Nautilus", category: "Arms", subcategory: "Triceps", cost: 1700, marketValue: 0, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", notes: "Bought from Paul, paid in cash" },
  ...
  { id: "tdm-cybex-eagle-abdominal", name: "Cybex Eagle Abdominal", brand: "Cybex", category: "Other", subcategory: "Other", cost: 0, marketValue: 0, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use" },
  ...
  { id: "unity-burton-ref647", name: "Precor PL Discovery Incline Press", brand: "Precor", category: "Chest", subcategory: "Presses", tdmRef: "647", cost: 0, marketValue: 950, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref648", name: "Nautilus Inspiration Pec Fly / Rear Delt", brand: "Nautilus", category: "Chest", subcategory: "Pec Decs / Flies", tdmRef: "648", cost: 0, marketValue: 1500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref274", name: "Force Pec Dec", brand: "Force", category: "Chest", subcategory: "Pec Decs / Flies", tdmRef: "274", cost: 0, marketValue: 500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref650", name: "Precor Icarian 505 Pec Fly / Rear Delt", brand: "Precor Icarian", category: "Chest", subcategory: "Pec Decs / Flies", tdmRef: "650", cost: 0, marketValue: 2000, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref651", name: "White PL Shrug", brand: "", category: "Shoulders", tdmRef: "651", cost: 0, marketValue: 500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref652", name: "Hammer Strength Iso-Lateral Shoulder Press", brand: "Hammer Strength", category: "Shoulders", subcategory: "Presses", tdmRef: "652", cost: 0, marketValue: 950, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref653", name: "Cybex VR3 Overhead Press", brand: "Cybex", category: "Shoulders", subcategory: "Presses", tdmRef: "653", cost: 0, marketValue: 2450, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref654", name: "Nautilus Nitro Overhead Press", brand: "Nautilus", category: "Shoulders", subcategory: "Presses", tdmRef: "654", cost: 0, marketValue: 2200, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref655", name: "Precor Icarian FT555 Shoulder Press", brand: "Precor Icarian", category: "Shoulders", subcategory: "Presses", tdmRef: "655", cost: 0, marketValue: 1500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref657", name: "Hammer Strength MTS Front Pulldown", brand: "Hammer Strength", category: "Back", subcategory: "Pulldowns", tdmRef: "657", cost: 0, marketValue: 950, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref658", name: "Hoist HD-2300 Lat Pulldown", brand: "Hoist", category: "Back", subcategory: "Pulldowns", tdmRef: "658", cost: 0, marketValue: 1200, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref659", name: "Ironborn PL Pulldown", brand: "Ironborn", category: "Back", subcategory: "Pulldowns", tdmRef: "659", cost: 0, marketValue: 500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref660", name: "Nautilus ONE Lat Pulldown", brand: "Nautilus", category: "Back", subcategory: "Pulldowns", tdmRef: "660", cost: 0, marketValue: 1400, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref661", name: "Hoist ROC-IT Lat Pulldown", brand: "Hoist", category: "Back", subcategory: "Pulldowns", tdmRef: "661", cost: 0, marketValue: 1400, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref662", name: "SportsArt PL Lat Pulldown", brand: "SportsArt", category: "Back", subcategory: "Pulldowns", tdmRef: "662", cost: 0, marketValue: 500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref663", name: "Cybex VR1 Lat Pulldown", brand: "Cybex", category: "Back", subcategory: "Pulldowns", tdmRef: "663", cost: 0, marketValue: 1200, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref664", name: "Nytram T-Bar Row", brand: "Nytram", category: "Back", subcategory: "Rows", tdmRef: "664", cost: 0, marketValue: 500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref665", name: "Precor Icarian FT332 Row", brand: "Precor Icarian", category: "Back", subcategory: "Rows", tdmRef: "665", cost: 0, marketValue: 1000, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref666", name: "Hammer Strength Iso-Lateral Low Row", brand: "Hammer Strength", category: "Back", subcategory: "Rows", tdmRef: "666", cost: 0, marketValue: 950, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref667", name: "Nautilus Row", brand: "Nautilus", category: "Back", subcategory: "Rows", tdmRef: "667", cost: 0, marketValue: 1200, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref668", name: "Cutler Extreme Row", brand: "Cutler", category: "Back", subcategory: "Rows", tdmRef: "668", cost: 0, marketValue: 500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref669", name: "Cybex Plate Loaded Row", brand: "Cybex", category: "Back", subcategory: "Rows", tdmRef: "669", cost: 0, marketValue: 1500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref670", name: "Hammer Strength MTS Row", brand: "Hammer Strength", category: "Back", subcategory: "Rows", tdmRef: "670", cost: 0, marketValue: 1000, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref671", name: "T-Bar Row", brand: "", category: "Back", subcategory: "Rows", tdmRef: "671", cost: 0, marketValue: 500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref672", name: "Elite Gym Gear Standing Tibialis Raise", brand: "Elite Gym Gear", category: "Back", tdmRef: "672", cost: 0, marketValue: 350, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref673", name: "Life Fitness Pro1 Lateral Raise", brand: "Life Fitness", category: "Back", tdmRef: "673", cost: 0, marketValue: 3000, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref155", name: "Bodymasters Pullover", brand: "Bodymasters", category: "Back", subcategory: "Pullover", tdmRef: "155", cost: 0, marketValue: 4000, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref649", name: "Life Fitness Pro Linear Leg Press", brand: "Life Fitness", category: "Legs", subcategory: "Compounds", tdmRef: "649", cost: 0, marketValue: 2000, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref674", name: "Cybex Squat Press", brand: "Cybex", category: "Legs", subcategory: "Compounds", tdmRef: "674", cost: 0, marketValue: 3500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  ...
  { id: "unity-burton-ref680", name: "Cybex VR1 Leg Extension / Leg Curl", brand: "Cybex", category: "Legs", subcategory: "Leg Curls", tdmRef: "680", cost: 0, marketValue: 1500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref681", name: "Cybex VR3 PL Kneeling Leg Curl", brand: "Cybex", category: "Legs", subcategory: "Leg Curls", tdmRef: "681", cost: 0, marketValue: 2000, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref682", name: "Life Fitness Pro1 Standing Leg Curl", brand: "Life Fitness", category: "Legs", subcategory: "Leg Curls", tdmRef: "682", cost: 0, marketValue: 700, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref246", name: "Cybex VR2 Leg Curl", brand: "Cybex", category: "Legs", subcategory: "Leg Curls", tdmRef: "246", cost: 0, marketValue: 1800, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref684", name: "Hammer Strength PL Leg Extension", brand: "Hammer Strength", category: "Legs", subcategory: "Leg Extensions", tdmRef: "684", cost: 0, marketValue: 950, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref685", name: "Cybex VR2", brand: "Cybex", category: "Legs", subcategory: "Leg Extensions", tdmRef: "685", cost: 0, marketValue: 1800, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref367", name: "Magnum Leg Extension", brand: "Magnum", category: "Legs", subcategory: "Leg Extensions", tdmRef: "367", cost: 0, marketValue: 2500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref683", name: "Dual Adjustable Pulley", brand: "", category: "Legs", tdmRef: "683", cost: 0, marketValue: 0, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  ...
  { id: "unity-burton-ref693", name: "Hammer Strength GHD", brand: "Hammer Strength", category: "Legs", tdmRef: "693", cost: 0, marketValue: 600, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref223", name: "Booty Builder V8 Hip Thrust", brand: "Booty Builder", category: "Legs", subcategory: "Glutes / Hips", tdmRef: "223", cost: 0, marketValue: 4000, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref694", name: "Cybex Classic PL Seated Calf Raise", brand: "Cybex", category: "Legs", subcategory: "Calves", tdmRef: "694", cost: 0, marketValue: 1000, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref695", name: "Nautilus 2ST Dip", brand: "Nautilus", category: "Arms", subcategory: "Triceps", tdmRef: "695", cost: 0, marketValue: 2000, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref338", name: "Nautilus Nitro Plus Bicep Curl", brand: "Nautilus", category: "Arms", subcategory: "Biceps", tdmRef: "338", cost: 0, marketValue: 1500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref696", name: "Paramount FL-35 Biceps / Triceps", brand: "Paramount", category: "Arms", tdmRef: "696", cost: 0, marketValue: 3500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref697", name: "Cybex PL Advance Bicep", brand: "Cybex", category: "Arms", subcategory: "Biceps", tdmRef: "697", cost: 0, marketValue: 1100, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref698", name: "Hoist ROC-IT Biceps Curl", brand: "Hoist", category: "Arms", subcategory: "Biceps", tdmRef: "698", cost: 0, marketValue: 1500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref699", name: "Hammer Strength Smith Machine", brand: "Hammer Strength", category: "Powerlifting", subcategory: "Racks", tdmRef: "699", cost: 0, marketValue: 2000, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref700", name: "Cybex Smith Machine", brand: "Cybex", category: "Powerlifting", subcategory: "Racks", tdmRef: "700", cost: 0, marketValue: 2500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref701", name: "VMX Multi-Mode Rope Trainer", brand: "VMX Multi-Mode", category: "Cardio", tdmRef: "701", cost: 0, marketValue: 500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref702", name: "Schwinn Airdyne AD8 Pro Air Bike", brand: "Schwinn", category: "Cardio", subcategory: "Bike", tdmRef: "702", cost: 0, marketValue: 250, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref703", name: "Life Fitness Integrity Series Treadmill", brand: "Life Fitness", category: "Cardio", subcategory: "Treadmill", tdmRef: "703", cost: 0, marketValue: 700, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref704", name: "Woodway-style clone Curve Manual Treadmill", brand: "Woodway-style clone", category: "Cardio", subcategory: "Treadmill", tdmRef: "704", cost: 0, marketValue: 700, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref705", name: "Life Fitness Lifecycle Recumbent Bike", brand: "Life Fitness", category: "Cardio", subcategory: "Bike", tdmRef: "705", cost: 0, marketValue: 350, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref706", name: "Life Fitness Lifecycle", brand: "Life Fitness", category: "Cardio", subcategory: "Bike", tdmRef: "706", cost: 0, marketValue: 350, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref707", name: "Star Trac TreadClimber", brand: "Star Trac", category: "Cardio", subcategory: "Stair", tdmRef: "707", cost: 0, marketValue: 700, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref708", name: "Life Fitness 8 Series PowerMill", brand: "Life Fitness", category: "Cardio", subcategory: "Stair", tdmRef: "708", cost: 0, marketValue: 1000, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref709", name: "StairMaster Gauntlet 8Gx", brand: "StairMaster", category: "Cardio", subcategory: "Stair", tdmRef: "709", cost: 0, marketValue: 1000, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref710", name: "Life Fitness Integrity Series Cross-Trainer", brand: "Life Fitness", category: "Cardio", subcategory: "Elliptical", tdmRef: "710", cost: 0, marketValue: 1500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref711", name: "Life Fitness Integrity Series Cross-Trainer", brand: "Life Fitness", category: "Cardio", subcategory: "Elliptical", tdmRef: "711", cost: 0, marketValue: 1500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref712", name: "Life Fitness Integrity Series Cross-Trainer", brand: "Life Fitness", category: "Cardio", subcategory: "Elliptical", tdmRef: "712", cost: 0, marketValue: 1500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref713", name: "Life Fitness Integrity Series Treadmill", brand: "Life Fitness", category: "Cardio", subcategory: "Treadmill", tdmRef: "713", cost: 0, marketValue: 1500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref714", name: "Life Fitness Integrity Series Treadmill", brand: "Life Fitness", category: "Cardio", subcategory: "Treadmill", tdmRef: "714", cost: 0, marketValue: 1500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref715", name: "Life Fitness Integrity Series Treadmill", brand: "Life Fitness", category: "Cardio", subcategory: "Treadmill", tdmRef: "715", cost: 0, marketValue: 1500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref716", name: "Concept2 SkiErg PM", brand: "Concept2", category: "Cardio", tdmRef: "716", cost: 0, marketValue: 500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref717", name: "Nautilus Dual Adjustable Pulley", brand: "Nautilus", category: "Other", tdmRef: "717", cost: 0, marketValue: 2500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref718", name: "Super Gym Dual Adjustable Pulley", brand: "Super Gym", category: "Other", tdmRef: "718", cost: 0, marketValue: 500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref719", name: "Viking Press", brand: "", category: "Other", tdmRef: "719", cost: 0, marketValue: 500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref720", name: "Pull-up / Dip", brand: "", category: "Other", tdmRef: "720", cost: 0, marketValue: 500, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref721", name: "PL Abdominal Crunch Bench", brand: "", category: "Other", tdmRef: "721", cost: 0, marketValue: 300, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref722", name: "Ab Bench", brand: "", category: "Other", tdmRef: "722", cost: 0, marketValue: 150, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  { id: "unity-burton-ref723", name: "Red GHD", brand: "", category: "Other", tdmRef: "723", cost: 0, marketValue: 150, currentLocation: "Unity Burton", destination: "Unity Burton", status: "In Use" },
  // ===== UNITY FRADLEY — SEPT 2026 ASSET ROSTER =====
  { id: "unity-fradley-ref724", name: "Life Fitness Incline Chest Press", brand: "Life Fitness", category: "Chest", subcategory: "Presses", tdmRef: "724", cost: 0, marketValue: 1000, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref725", name: "Life Fitness Pectoral Fly", brand: "Life Fitness", category: "Chest", subcategory: "Pec Decs / Flies", tdmRef: "725", cost: 0, marketValue: 850, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref726", name: "Life Fitness Chest Press", brand: "Life Fitness", category: "Chest", subcategory: "Presses", tdmRef: "726", cost: 0, marketValue: 1000, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref727", name: "Plate Loaded Flat Chest Press", brand: "", category: "Chest", subcategory: "Presses", tdmRef: "727", cost: 0, marketValue: 1000, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref728", name: "Ironborn Chest Fly", brand: "Ironborn", category: "Chest", subcategory: "Pec Decs / Flies", tdmRef: "728", cost: 0, marketValue: 1000, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref729", name: "Ironborn Decline Press", brand: "Ironborn", category: "Chest", subcategory: "Presses", tdmRef: "729", cost: 0, marketValue: 500, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref279", name: "Hoist Pec Fly", brand: "Hoist", category: "Chest", subcategory: "Pec Decs / Flies", tdmRef: "279", cost: 0, marketValue: 1750, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref730", name: "Ironborn Incline Press", brand: "Ironborn", category: "Chest", subcategory: "Presses", tdmRef: "730", cost: 0, marketValue: 500, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref731", name: "Strength Shop Competition Bench", brand: "Strength Shop", category: "Chest", subcategory: "Presses", tdmRef: "731", cost: 0, marketValue: 800, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref732", name: "Life Fitness Shoulder Press", brand: "Life Fitness", category: "Shoulders", subcategory: "Presses", tdmRef: "732", cost: 0, marketValue: 1000, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref733", name: "Side Lateral Raise", brand: "", category: "Shoulders", subcategory: "Laterals", tdmRef: "733", cost: 0, marketValue: 500, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref734", name: "Icarian Lateral Raise", brand: "Icarian", category: "Shoulders", subcategory: "Laterals", tdmRef: "734", cost: 0, marketValue: 1200, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref735", name: "Ironborn Shoulder Press", brand: "Ironborn", category: "Shoulders", subcategory: "Presses", tdmRef: "735", cost: 0, marketValue: 1000, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref736", name: "Life Fitness Lat Pulldown", brand: "Life Fitness", category: "Back", subcategory: "Pulldowns", tdmRef: "736", cost: 0, marketValue: 900, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref737", name: "Life Fitness Lat Pulldown", brand: "Life Fitness", category: "Back", subcategory: "Pulldowns", tdmRef: "737", cost: 0, marketValue: 900, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref738", name: "Davis Lat Pulldown", brand: "Davis", category: "Back", subcategory: "Pulldowns", tdmRef: "738", cost: 0, marketValue: 1350, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref739", name: "Nautilus Compound Row", brand: "Nautilus", category: "Back", subcategory: "Rows", tdmRef: "739", cost: 0, marketValue: 3000, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref740", name: "Power Sport Seated Row", brand: "Power Sport", category: "Back", subcategory: "Rows", tdmRef: "740", cost: 0, marketValue: 700, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref741", name: "Life Fitness Seated Row", brand: "Life Fitness", category: "Back", subcategory: "Rows", tdmRef: "741", cost: 0, marketValue: 900, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref742", name: "Taurus T-Bar Row", brand: "Taurus", category: "Back", subcategory: "Rows", tdmRef: "742", cost: 0, marketValue: 650, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref743", name: "Ironborn Seated Row", brand: "Ironborn", category: "Back", subcategory: "Rows", tdmRef: "743", cost: 0, marketValue: 900, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  ...
  { id: "unity-fradley-ref757", name: "Life Fitness Hip Abductor", brand: "Life Fitness", category: "Legs", subcategory: "Glutes / Hips", tdmRef: "757", cost: 0, marketValue: 850, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref758", name: "Life Fitness Standing Calf", brand: "Life Fitness", category: "Legs", subcategory: "Calves", tdmRef: "758", cost: 0, marketValue: 850, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref759", name: "Plate Loaded Seated Calf", brand: "", category: "Legs", subcategory: "Calves", tdmRef: "759", cost: 0, marketValue: 500, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref760", name: "Life Fitness Arm Extension", brand: "Life Fitness", category: "Arms", subcategory: "Triceps", tdmRef: "760", cost: 0, marketValue: 900, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  ...
  { id: "unity-fradley-ref766", name: "Strength Systems Power Rack", brand: "Strength Systems", category: "Powerlifting", subcategory: "Racks", tdmRef: "766", cost: 0, marketValue: 1000, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref767", name: "Strength Systems Squat Rack", brand: "Strength Systems", category: "Powerlifting", subcategory: "Racks", tdmRef: "767", cost: 0, marketValue: 1000, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref768", name: "Keiser Spin Bike", brand: "Keiser", category: "Cardio", subcategory: "Bike", tdmRef: "768", cost: 0, marketValue: 250, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref769", name: "Keiser Spin Bike", brand: "Keiser", category: "Cardio", subcategory: "Bike", tdmRef: "769", cost: 0, marketValue: 250, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref770", name: "Keiser Spin Bike", brand: "Keiser", category: "Cardio", subcategory: "Bike", tdmRef: "770", cost: 0, marketValue: 250, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref771", name: "Keiser Spin Bike", brand: "Keiser", category: "Cardio", subcategory: "Bike", tdmRef: "771", cost: 0, marketValue: 250, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref772", name: "Keiser Spin Bike", brand: "Keiser", category: "Cardio", subcategory: "Bike", tdmRef: "772", cost: 0, marketValue: 250, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref773", name: "Keiser Spin Bike", brand: "Keiser", category: "Cardio", subcategory: "Bike", tdmRef: "773", cost: 0, marketValue: 250, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref774", name: "Keiser Spin Bike", brand: "Keiser", category: "Cardio", subcategory: "Bike", tdmRef: "774", cost: 0, marketValue: 250, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  ...
  { id: "unity-fradley-ref786", name: "Life Fitness Bike", brand: "Life Fitness", category: "Cardio", subcategory: "Bike", tdmRef: "786", cost: 0, marketValue: 400, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref787", name: "Life Fitness Bike", brand: "Life Fitness", category: "Cardio", subcategory: "Bike", tdmRef: "787", cost: 0, marketValue: 400, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref788", name: "TechnoGym Stairmaster", brand: "TechnoGym", category: "Cardio", subcategory: "Stair", tdmRef: "788", cost: 0, marketValue: 3500, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref789", name: "Life Fitness PowerMill", brand: "Life Fitness", category: "Cardio", subcategory: "Stair", tdmRef: "789", cost: 0, marketValue: 3500, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  ...
  { id: "unity-fradley-ref798", name: "Life Fitness Cable Machine", brand: "Life Fitness", category: "Other", tdmRef: "798", cost: 0, marketValue: 1800, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref799", name: "Life Fitness Cable Machine", brand: "Life Fitness", category: "Other", tdmRef: "799", cost: 0, marketValue: 1800, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  { id: "unity-fradley-ref800", name: "Cable Machine", brand: "", category: "Other", tdmRef: "800", cost: 0, marketValue: 1000, currentLocation: "Unity Fradley", destination: "Unity Fradley", status: "In Use" },
  // ===== UNITY LICHFIELD — SEPT 2026 ASSET ROSTER =====
  { id: "unity-lichfield-ref280", name: "Nautilus Nitro Incline Press", brand: "Nautilus", category: "Chest", subcategory: "Presses", tdmRef: "280", cost: 0, marketValue: 3000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref573", name: "Paramount Seated Chest", brand: "Paramount", category: "Chest", subcategory: "Presses", tdmRef: "573", cost: 0, marketValue: 1500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref574", name: "Life Fitness Pec / Rear Delt", brand: "Life Fitness", category: "Chest", subcategory: "Pec Decs / Flies", tdmRef: "574", cost: 0, marketValue: 1000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref201", name: "Magnum Biangular Upper Chest", brand: "Magnum", category: "Chest", subcategory: "Presses", tdmRef: "201", cost: 0, marketValue: 2000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref575", name: "Cybex Chest Press (red seat)", brand: "Cybex", category: "Chest", subcategory: "Presses", tdmRef: "575", cost: 0, marketValue: 2000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref576", name: "Precor PL Incline Press", brand: "Precor", category: "Chest", subcategory: "Presses", tdmRef: "576", cost: 0, marketValue: 1750, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref578", name: "Incline Bench", brand: "", category: "Chest", subcategory: "Presses", tdmRef: "578", cost: 0, marketValue: 500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref579", name: "Strength Shop Competition Bench", brand: "Strength Shop", category: "Chest", subcategory: "Presses", tdmRef: "579", cost: 0, marketValue: 500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref580", name: "Cutler PL Bench", brand: "Cutler", category: "Chest", subcategory: "Presses", tdmRef: "580", cost: 0, marketValue: 500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref335", name: "Nautilus Nitro Pec Fly Rear Delt", brand: "Nautilus", category: "Chest", subcategory: "Pec Decs / Flies", tdmRef: "335", cost: 0, marketValue: 2500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref581", name: "Flat Bench", brand: "", category: "Chest", subcategory: "Presses", tdmRef: "581", cost: 0, marketValue: 500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref208", name: "Nautilus Xpload Overhead Press", brand: "Nautilus", category: "Shoulders", subcategory: "Presses", tdmRef: "208", cost: 0, marketValue: 4000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  ...
  { id: "unity-lichfield-ref588", name: "Life Fitness Selectorised Pulldown (black)", brand: "Life Fitness", category: "Back", subcategory: "Pulldowns", tdmRef: "588", cost: 0, marketValue: 1000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref589", name: "Life Fitness Selectorised Pulldown (red seat)", brand: "Life Fitness", category: "Back", subcategory: "Pulldowns", tdmRef: "589", cost: 0, marketValue: 1500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref590", name: "TechnoGym Low Row", brand: "TechnoGym", category: "Back", subcategory: "Rows", tdmRef: "590", cost: 0, marketValue: 1500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref591", name: "Primal Strength Seated Horizontal Pulley", brand: "Primal Strength", category: "Back", subcategory: "Rows", tdmRef: "591", cost: 0, marketValue: 1750, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref592", name: "Cybex Eagle Row", brand: "Cybex", category: "Back", subcategory: "Rows", tdmRef: "592", cost: 0, marketValue: 5000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref337", name: "Nautilus Nitro Mid Row", brand: "Nautilus", category: "Back", subcategory: "Rows", tdmRef: "337", cost: 0, marketValue: 3000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref593", name: "Primal Strength T-Bar Row", brand: "Primal Strength", category: "Back", subcategory: "Rows", tdmRef: "593", cost: 0, marketValue: 900, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref594", name: "PL Standing Lateral Raise", brand: "", category: "Shoulders", subcategory: "Laterals", tdmRef: "594", cost: 0, marketValue: 500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  ...
  { id: "unity-lichfield-ref135", name: "Magnum Leg Extension", brand: "Magnum", category: "Legs", subcategory: "Leg Extensions", tdmRef: "135", cost: 0, marketValue: 2500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref604", name: "Nautilus Nitro Plus Leg Extension", brand: "Nautilus", category: "Legs", subcategory: "Leg Extensions", tdmRef: "604", cost: 0, marketValue: 2000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref605", name: "Matrix Adductor", brand: "Matrix", category: "Legs", subcategory: "Adductors", tdmRef: "605", cost: 0, marketValue: 500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref606", name: "Matrix Abductor", brand: "Matrix", category: "Legs", subcategory: "Glutes / Hips", tdmRef: "606", cost: 0, marketValue: 500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref607", name: "Life Fitness PL Calf Raise", brand: "Life Fitness", category: "Legs", subcategory: "Calves", tdmRef: "607", cost: 0, marketValue: 1000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref608", name: "Hammer Strength PL Kneeling Leg Curl", brand: "Hammer Strength", category: "Legs", subcategory: "Leg Curls", tdmRef: "608", cost: 0, marketValue: 1000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  ...
  { id: "unity-lichfield-ref627", name: "Primal Strength Squat Rack", brand: "Primal Strength", category: "Powerlifting", subcategory: "Racks", tdmRef: "627", cost: 0, marketValue: 2000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref626", name: "Primal Strength Squat Rack", brand: "Primal Strength", category: "Powerlifting", subcategory: "Racks", tdmRef: "626", cost: 0, marketValue: 600, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref625", name: "Primal Strength Squat Rack", brand: "Primal Strength", category: "Powerlifting", subcategory: "Racks", tdmRef: "625", cost: 0, marketValue: 600, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref615", name: "Primal Strength Squat Rack", brand: "Primal Strength", category: "Powerlifting", subcategory: "Racks", tdmRef: "615", cost: 0, marketValue: 600, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref616", name: "Strength Shop Deadlift Platform", brand: "Strength Shop", category: "Powerlifting", subcategory: "Platforms", tdmRef: "616", cost: 0, marketValue: 200, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref617", name: "Assault Fitness Air Runner Manual Treadmill", brand: "Assault Fitness", category: "Cardio", subcategory: "Treadmill", tdmRef: "617", cost: 0, marketValue: 1000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref629", name: "Pulse Fitness U Cycle", brand: "Pulse Fitness", category: "Cardio", subcategory: "Bike", tdmRef: "629", cost: 0, marketValue: 300, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref631", name: "Pulse Fitness U Cycle", brand: "Pulse Fitness", category: "Cardio", subcategory: "Bike", tdmRef: "631", cost: 0, marketValue: 300, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref630", name: "Pulse Fitness U Cycle", brand: "Pulse Fitness", category: "Cardio", subcategory: "Bike", tdmRef: "630", cost: 0, marketValue: 300, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref628", name: "Pulse Fitness U Cycle", brand: "Pulse Fitness", category: "Cardio", subcategory: "Bike", tdmRef: "628", cost: 0, marketValue: 300, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref618", name: "Pulse Fitness U Cycle", brand: "Pulse Fitness", category: "Cardio", subcategory: "Bike", tdmRef: "618", cost: 0, marketValue: 300, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref632", name: "Assault Fitness Air Bike", brand: "Assault Fitness", category: "Cardio", subcategory: "Bike", tdmRef: "632", cost: 0, marketValue: 1000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref619", name: "Assault Fitness Air Bike", brand: "Assault Fitness", category: "Cardio", subcategory: "Bike", tdmRef: "619", cost: 0, marketValue: 1000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref633", name: "Ski Trainer Ski Erg", brand: "Ski Trainer", category: "Cardio", tdmRef: "633", cost: 0, marketValue: 500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref620", name: "Ski Trainer Ski Erg", brand: "Ski Trainer", category: "Cardio", tdmRef: "620", cost: 0, marketValue: 500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref621", name: "StairMaster Gauntlet StepMill 8 Series", brand: "StairMaster", category: "Cardio", subcategory: "Stair", tdmRef: "621", cost: 0, marketValue: 3000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref622", name: "Life Fitness PowerMill Climber", brand: "Life Fitness", category: "Cardio", subcategory: "Stair", tdmRef: "622", cost: 0, marketValue: 3000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref623", name: "Marpo Kinetics VMX Functional Rope Trainer", brand: "Marpo Kinetics", category: "Cardio", tdmRef: "623", cost: 0, marketValue: 2000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref624", name: "Pulse Fitness Cross Trainer", brand: "Pulse Fitness", category: "Cardio", subcategory: "Elliptical", tdmRef: "624", cost: 0, marketValue: 1500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref634", name: "Pulse Fitness Cross Trainer", brand: "Pulse Fitness", category: "Cardio", subcategory: "Elliptical", tdmRef: "634", cost: 0, marketValue: 1500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref635", name: "Pulse Fitness Cross Trainer", brand: "Pulse Fitness", category: "Cardio", subcategory: "Elliptical", tdmRef: "635", cost: 0, marketValue: 1500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-cybex-360-dap", name: "Cybex 360 Dap", brand: "Cybex", category: "Other", cost: 0, marketValue: 800, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-grey-on-wall-bicep-tricep", name: "Grey On-Wall Bicep / Tricep", brand: "", category: "Other", cost: 0, marketValue: 800, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-precor-icarian-cable-machine", name: "Precor Icarian Cable Machine", brand: "Precor Icarian", category: "Other", cost: 0, marketValue: 2000, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-exigo-dual-adjustable-pulley", name: "Exigo Dual Adjustable Pulley", brand: "Exigo", category: "Other", cost: 0, marketValue: 1500, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-black-ghd", name: "Black GHD", brand: "", category: "Other", cost: 0, marketValue: 450, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-precor-abdominal-crunch", name: "Precor Abdominal Crunch", brand: "Precor", category: "Other", cost: 0, marketValue: 750, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-life-fitness-adjustable-decline-ab-crunch", name: "Life Fitness Adjustable Decline Ab Crunch", brand: "Life Fitness", category: "Other", cost: 0, marketValue: 750, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  { id: "unity-lichfield-ref377", name: "David Tricep Pushdown", brand: "David", category: "Arms", subcategory: "Triceps", tdmRef: "377", cost: 0, marketValue: 0, currentLocation: "Unity Lichfield", destination: "Unity Lichfield", status: "In Use" },
  // ===== UNITY TAMWORTH — SEPT 2026 ASSET ROSTER =====
  { id: "unity-tamworth-ref500", name: "Nautilus Impact Chest Press", brand: "Nautilus", category: "Chest", subcategory: "Presses", tdmRef: "500", cost: 0, marketValue: 1500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref501", name: "Precor Discovery Chest Press", brand: "Precor", category: "Chest", subcategory: "Presses", tdmRef: "501", cost: 0, marketValue: 1500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref502", name: "Life Fitness Signature Pec Fly / Rear Delt", brand: "Life Fitness", category: "Chest", subcategory: "Pec Decs / Flies", tdmRef: "502", cost: 0, marketValue: 1100, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref503", name: "Precor Icarian Pec Fly / Rear Delt", brand: "Precor Icarian", category: "Chest", subcategory: "Pec Decs / Flies", tdmRef: "503", cost: 0, marketValue: 1500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref105", name: "Cybex VR2 Chest Press (white)", brand: "Cybex", category: "Chest", subcategory: "Presses", tdmRef: "105", cost: 0, marketValue: 1250, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref504", name: "Cutler Reloaded Pec Fly", brand: "Cutler", category: "Chest", subcategory: "Pec Decs / Flies", tdmRef: "504", cost: 0, marketValue: 600, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref505", name: "Cybex VR3 Plate Loaded Incline Chest Press", brand: "Cybex", category: "Chest", subcategory: "Presses", tdmRef: "505", cost: 0, marketValue: 1800, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref506", name: "Hammer Strength Plate Loaded Iso-Lateral Press", brand: "Hammer Strength", category: "Chest", subcategory: "Presses", tdmRef: "506", cost: 0, marketValue: 900, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref372", name: "Magnum Badger Incline", brand: "Magnum", category: "Chest", subcategory: "Presses", tdmRef: "372", cost: 0, marketValue: 1200, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref507", name: "Pec Dec / Rear Delt", brand: "", category: "Chest", subcategory: "Pec Decs / Flies", tdmRef: "507", cost: 0, marketValue: 900, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref354", name: "Magnum Lateral Raise", brand: "Magnum", category: "Shoulders", subcategory: "Laterals", tdmRef: "354", cost: 0, marketValue: 2000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref508", name: "Precor Shoulder Press", brand: "Precor", category: "Shoulders", subcategory: "Presses", tdmRef: "508", cost: 0, marketValue: 1300, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref509", name: "Precor Shoulder Press FT555", brand: "Precor", category: "Shoulders", subcategory: "Presses", tdmRef: "509", cost: 0, marketValue: 1300, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref510", name: "Plate Loaded Viking Press", brand: "", category: "Shoulders", tdmRef: "510", cost: 0, marketValue: 500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref511", name: "Plate Loaded Seated Shrug", brand: "", category: "Shoulders", tdmRef: "511", cost: 0, marketValue: 500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref512", name: "Precor Icarian Lat Pulldown", brand: "Precor Icarian", category: "Back", subcategory: "Pulldowns", tdmRef: "512", cost: 0, marketValue: 1000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref513", name: "Hoist CL 2201 Lat Pulldown", brand: "Hoist", category: "Back", subcategory: "Pulldowns", tdmRef: "513", cost: 0, marketValue: 1000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref514", name: "Hoist Roc-It Lat Pulldown", brand: "Hoist", category: "Back", subcategory: "Pulldowns", tdmRef: "514", cost: 0, marketValue: 1000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  ...
  { id: "unity-tamworth-ref521", name: "Hoist HS 1725 Mid Row", brand: "Hoist", category: "Back", subcategory: "Rows", tdmRef: "521", cost: 0, marketValue: 1000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref522", name: "Hoist Roc-It Mid Row", brand: "Hoist", category: "Back", subcategory: "Rows", tdmRef: "522", cost: 0, marketValue: 1000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  ...
  { id: "unity-tamworth-ref528", name: "Cybex VR3 Squat Press", brand: "Cybex", category: "Legs", subcategory: "Compounds", tdmRef: "528", cost: 0, marketValue: 3800, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref529", name: "Exigo Plate Loaded ISO Leg Press", brand: "Exigo", category: "Legs", subcategory: "Compounds", tdmRef: "529", cost: 0, marketValue: 1000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  ...
  { id: "unity-tamworth-ref537", name: "Cybex VR Leg Extension", brand: "Cybex", category: "Legs", subcategory: "Leg Extensions", tdmRef: "537", cost: 0, marketValue: 1200, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref538", name: "Cybex VR3 Plate Loaded Leg Extension", brand: "Cybex", category: "Legs", subcategory: "Leg Extensions", tdmRef: "538", cost: 0, marketValue: 1500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref539", name: "Precor Leg Extension", brand: "Precor", category: "Legs", subcategory: "Leg Extensions", tdmRef: "539", cost: 0, marketValue: 1000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref540", name: "Life Fitness Standing Calf", brand: "Life Fitness", category: "Legs", subcategory: "Calves", tdmRef: "540", cost: 0, marketValue: 500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref541", name: "BodyMax Rear Kick", brand: "BodyMax", category: "Legs", subcategory: "Glutes / Hips", tdmRef: "541", cost: 0, marketValue: 500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref542", name: "Life Fitness Plate Loaded Calf Raise", brand: "Life Fitness", category: "Legs", subcategory: "Calves", tdmRef: "542", cost: 0, marketValue: 500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref543", name: "Hammer Strength GHD", brand: "Hammer Strength", category: "Legs", tdmRef: "543", cost: 0, marketValue: 650, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref544", name: "Precor Icarian Abductor", brand: "Precor Icarian", category: "Legs", subcategory: "Glutes / Hips", tdmRef: "544", cost: 0, marketValue: 900, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref545", name: "Nautilus Inspiration Abductor / Adductor", brand: "Nautilus", category: "Legs", subcategory: "Adductors", tdmRef: "545", cost: 0, marketValue: 1200, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref224", name: "Booty Builder V8 Hip Thrust", brand: "Booty Builder", category: "Legs", subcategory: "Glutes / Hips", tdmRef: "224", cost: 0, marketValue: 3000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref147", name: "Precor Icarian Donkey Calf", brand: "Precor Icarian", category: "Legs", subcategory: "Calves", tdmRef: "147", cost: 0, marketValue: 3500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref546", name: "Nautilus Glute Drive (Plate Loaded)", brand: "Nautilus", category: "Legs", subcategory: "Glutes / Hips", tdmRef: "546", cost: 0, marketValue: 2500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref547", name: "Dip Machine", brand: "", category: "Arms", subcategory: "Triceps", tdmRef: "547", cost: 0, marketValue: 1000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref548", name: "Nautilus Nitro SA Tricep Extension", brand: "Nautilus", category: "Arms", subcategory: "Triceps", tdmRef: "548", cost: 0, marketValue: 1200, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref549", name: "Preacher Bench", brand: "", category: "Arms", subcategory: "Biceps", tdmRef: "549", cost: 0, marketValue: 100, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref351", name: "Magnum Bicep Curl", brand: "Magnum", category: "Arms", subcategory: "Biceps", tdmRef: "351", cost: 0, marketValue: 500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  ...
  { id: "unity-tamworth-ref555", name: "Hammer Strength Rack", brand: "Hammer Strength", category: "Powerlifting", subcategory: "Racks", tdmRef: "555", cost: 0, marketValue: 500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref641", name: "StairMaster StairMaster", brand: "StairMaster", category: "Powerlifting", tdmRef: "641", cost: 0, marketValue: 3500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref556", name: "StairMaster StairMaster", brand: "StairMaster", category: "Cardio", subcategory: "Stair", tdmRef: "556", cost: 0, marketValue: 3500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref557", name: "Life Fitness PowerMill", brand: "Life Fitness", category: "Cardio", subcategory: "Stair", tdmRef: "557", cost: 0, marketValue: 3500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref558", name: "Jacobs Ladder Ladder", brand: "Jacobs Ladder", category: "Cardio", subcategory: "Stair", tdmRef: "558", cost: 0, marketValue: 1000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref642", name: "Precor Bike", brand: "Precor", category: "Cardio", subcategory: "Bike", tdmRef: "642", cost: 0, marketValue: 300, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref559", name: "Precor Bike", brand: "Precor", category: "Cardio", subcategory: "Bike", tdmRef: "559", cost: 0, marketValue: 300, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref636", name: "Life Fitness Treadmill", brand: "Life Fitness", category: "Cardio", subcategory: "Treadmill", tdmRef: "636", cost: 0, marketValue: 1000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref637", name: "Life Fitness Treadmill", brand: "Life Fitness", category: "Cardio", subcategory: "Treadmill", tdmRef: "637", cost: 0, marketValue: 1000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref638", name: "Life Fitness Treadmill", brand: "Life Fitness", category: "Cardio", subcategory: "Treadmill", tdmRef: "638", cost: 0, marketValue: 1000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref639", name: "Life Fitness Treadmill", brand: "Life Fitness", category: "Cardio", subcategory: "Treadmill", tdmRef: "639", cost: 0, marketValue: 1000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref560", name: "Life Fitness Treadmill", brand: "Life Fitness", category: "Cardio", subcategory: "Treadmill", tdmRef: "560", cost: 0, marketValue: 1000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref561", name: "TechnoGym Curved Treadmill", brand: "TechnoGym", category: "Cardio", subcategory: "Treadmill", tdmRef: "561", cost: 0, marketValue: 1000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref562", name: "Watt Bike Bike", brand: "Watt Bike", category: "Cardio", subcategory: "Bike", tdmRef: "562", cost: 0, marketValue: 500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref563", name: "Matrix Recumbent Bike", brand: "Matrix", category: "Cardio", subcategory: "Bike", tdmRef: "563", cost: 0, marketValue: 300, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref564", name: "Precor C846i Recumbent Bike", brand: "Precor", category: "Cardio", subcategory: "Bike", tdmRef: "564", cost: 0, marketValue: 300, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref565", name: "Precor EFX 556i Elliptical", brand: "Precor", category: "Cardio", subcategory: "Elliptical", tdmRef: "565", cost: 0, marketValue: 500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref566", name: "Concept2 SkiErg", brand: "Concept2", category: "Cardio", tdmRef: "566", cost: 0, marketValue: 500, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref567", name: "Hoist Cable Crossover", brand: "Hoist", category: "Other", tdmRef: "567", cost: 0, marketValue: 900, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref568", name: "Life Fitness Cable Crossover", brand: "Life Fitness", category: "Other", tdmRef: "568", cost: 0, marketValue: 900, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref569", name: "Life Fitness DAP", brand: "Life Fitness", category: "Other", tdmRef: "569", cost: 0, marketValue: 0, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref570", name: "DAP", brand: "", category: "Other", tdmRef: "570", cost: 0, marketValue: 0, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref571", name: "Precor Seated DAP", brand: "Precor", category: "Other", tdmRef: "571", cost: 0, marketValue: 900, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-ref572", name: "Precor Assisted Chin / Dip", brand: "Precor", category: "Other", tdmRef: "572", cost: 0, marketValue: 900, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  { id: "unity-tamworth-boxing-ring", name: "Boxing Ring", brand: "", category: "Other", cost: 0, marketValue: 1000, currentLocation: "Unity Tamworth", destination: "Unity Tamworth", status: "In Use" },
  ...
  { id: "cybex-galileo-leg-ext", name: "Cybex Galileo Leg Extension", brand: "Cybex", category: "Legs", subcategory: "Leg Extensions", tdmRef: "323", cost: 500, marketValue: 1500, currentLocation: "WBAK HQ", destination: "TDM Gym", status: "In Refurb", refurbStage: "Landed", notes: "Cybex sticker on stack casing & remake info sticker" },
  ...
  { id: "matrix-plate-trees", name: "Matrix Plate Trees", brand: "Matrix", category: "Accessories", subcategory: "Storage", cost: 80, marketValue: 0, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", notes: "Qty: 3" },
  ...
  // ===== TDM GYM SEPT 2026 FULL ASSET ROSTER — second-instance units confirmed landed =====
  ...
  { id: "magnum-biangular-upper-chest-tdm2", name: "Magnum Biangular Upper Chest", brand: "Magnum", category: "Chest", subcategory: "Presses", tdmRef: "153", cost: 1700, marketValue: 2000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", seller: "Bellevue, IL" },
  ...
  { id: "bodymasters-pec-fly-rear-delt-tdm2", name: "Bodymasters Pec Fly / Rear Delt", brand: "Bodymasters", category: "Chest", subcategory: "Pec Decs / Flies", tdmRef: "149", cost: 1200, marketValue: 3200, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", seller: "Morelia" },
  { id: "naut-2st-shoulder-press-tdm2", name: "Nautilus 2ST Shoulder Press", brand: "Nautilus", category: "Shoulders", subcategory: "Presses", tdmRef: "253", cost: 1500, marketValue: 2500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", seller: "Moxee, WA" },
  { id: "flex-deltoid-raise-tdm2", name: "Flex Fitness Deltoid Raise", brand: "Flex Fitness", category: "Shoulders", subcategory: "Laterals", tdmRef: "209", cost: 2900, marketValue: 3500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", seller: "Florence" },
  ...
  { id: "hoist-star-pulldown-tdm2", name: "Hoist Star Pulldown", brand: "Hoist", category: "Back", subcategory: "Pulldowns", tdmRef: "191", cost: 0, marketValue: 1500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", seller: "Redditch" },
  ...
  { id: "cybex-v1-hack-tdm2", name: "Cybex V1 Hack Squat", brand: "Cybex", category: "Legs", subcategory: "Compounds", tdmRef: "131", cost: 6200, marketValue: 11000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", seller: "Bellevue, IL" },
  ...
  { id: "icarian-lying-lp-tdm2", name: "Icarian Lying Leg Press", brand: "Icarian", category: "Legs", subcategory: "Compounds", tdmRef: "125", cost: 1500, marketValue: 2500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", seller: "Albuquerque, NM" },
  ...
  { id: "flex-classic-adductor-tdm2", name: "Flex Fitness Classic Adductor", brand: "Flex Fitness", category: "Legs", subcategory: "Adductors", tdmRef: "319", cost: 1700, marketValue: 2000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use" },
  ...
  { id: "strive-pl-preacher-tdm2", name: "Strive PL Preacher Curl", brand: "Strive", category: "Arms", subcategory: "Biceps", tdmRef: "177", cost: 2700, marketValue: 3750, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", seller: "Salt Lake City, UT" },
  ...
  { id: "tdm-gym-104", name: "Cybex VR Row", brand: "Cybex", category: "Other", tdmRef: "104", cost: 770, marketValue: 3500, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use", seller: "Jackson, MS" },
  { id: "tdm-gym-398", name: "MedX Selectorised Row", brand: "MedX", category: "Other", tdmRef: "398", cost: 5500, marketValue: 6000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use" },
  { id: "tdm-gym-355", name: "Magnum Mid Row", brand: "Magnum", category: "Other", tdmRef: "355", cost: 1220, marketValue: 0, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use" },
  { id: "tdm-gym-370", name: "Magnum T Bar Row", brand: "Magnum", category: "Other", tdmRef: "370", cost: 500, marketValue: 1200, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use" },
  { id: "tdm-gym-399", name: "Jamn Squat", brand: "Jamn", category: "Other", tdmRef: "399", cost: 3300, marketValue: 4000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use" },
  { id: "tdm-gym-400", name: "Rogers Pit Shark", brand: "Rogers", category: "Other", tdmRef: "400", cost: 3500, marketValue: 5000, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use" },
  ...
  { id: "tdm-gym-286", name: "Sportkraft Xtreme Squat Bar 30kg", brand: "Sportkraft", category: "Other", tdmRef: "286", cost: 587, marketValue: 450, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use" },
  { id: "tdm-gym-287", name: "Sportkraft Xtreme Bench Bar 25kg", brand: "Sportkraft", category: "Other", tdmRef: "287", cost: 432, marketValue: 350, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use" },
  { id: "tdm-gym-288", name: "Sportkraft Buffalo Bar", brand: "Sportkraft", category: "Other", tdmRef: "288", cost: 336, marketValue: 250, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use" },
  { id: "tdm-gym-289", name: "Sportkraft Bench Camber Bar", brand: "Sportkraft", category: "Other", tdmRef: "289", cost: 155, marketValue: 100, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use" },
  { id: "tdm-gym-290", name: "Sportkraft Swiss Bar", brand: "Sportkraft", category: "Other", tdmRef: "290", cost: 155, marketValue: 100, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use" },
  { id: "tdm-gym-291", name: "Sportkraft 210cm Fat Bar", brand: "Sportkraft", category: "Other", tdmRef: "291", cost: 104, marketValue: 100, currentLocation: "TDM Gym", destination: "TDM Gym", status: "In Use" },

  // ===== WBAK STOCK LIST AUG 2026 — NEW ITEMS (no prior record) =====
  ...
  { id: "wbak-203", name: "Cybex VR2 Lat Pulldown", brand: "Cybex", category: "Other", tdmRef: "203", cost: 2000, marketValue: 2600, currentLocation: "WBAK HQ", destination: "Undecided", status: "At HQ" },
  ...
  { id: "wbak-162", name: "Flex Fitness Leverage Shoulder Press", brand: "Flex Fitness", category: "Other", tdmRef: "162", cost: 4500, marketValue: 5000, currentLocation: "WBAK HQ", destination: "Undecided", status: "At HQ" },
  { id: "wbak-206", name: "Flex Fitness Incline Press", brand: "Flex Fitness", category: "Other", tdmRef: "206", cost: 3000, marketValue: 3750, currentLocation: "WBAK HQ", destination: "Undecided", status: "At HQ" },
  { id: "wbak-134", name: "Flex Fitness Classic Angled Leg Press", brand: "Flex Fitness", category: "Other", tdmRef: "134", cost: 0, marketValue: 3500, currentLocation: "WBAK HQ", destination: "Undecided", status: "At HQ" },
  { id: "wbak-123", name: "Flex Fitness Leg Extension (black and white)", brand: "Flex Fitness", category: "Other", tdmRef: "123", cost: 3400, marketValue: 5000, currentLocation: "WBAK HQ", destination: "Undecided", status: "At HQ" },
  { id: "wbak-141", name: "Flex Fitness Leg Extension with Adjustable Cam", brand: "Flex Fitness", category: "Other", tdmRef: "141", cost: 3400, marketValue: 5000, currentLocation: "WBAK HQ", destination: "Undecided", status: "At HQ" },
  { id: "wbak-376", name: "Flex Fitness Abdominal Machine", brand: "Flex Fitness", category: "Other", tdmRef: "376", cost: 1000, marketValue: 2000, currentLocation: "WBAK HQ", destination: "Undecided", status: "At HQ" },
  ...
  { id: "wbak-120", name: "Bodymasters MD3318 Incline Press", brand: "Bodymasters", category: "Other", tdmRef: "120", cost: 2400, marketValue: 2750, currentLocation: "WBAK HQ", destination: "Undecided", status: "At HQ" },
  { id: "wbak-121", name: "Bodymasters CX114 Abductor", brand: "Bodymasters", category: "Other", tdmRef: "121", cost: 2000, marketValue: 2200, currentLocation: "WBAK HQ", destination: "Undecided", status: "At HQ" },
  ...
  { id: "wbak-348", name: "Nautilus Fixed Lat Pulldown", brand: "Nautilus", category: "Other", tdmRef: "348", cost: 0, marketValue: 1000, currentLocation: "WBAK HQ", destination: "Undecided", status: "At HQ" },
  ...
  { id: "wbak-207", name: "Paramount Rotary Chest Press", brand: "Paramount", category: "Other", tdmRef: "207", cost: 0, marketValue: 1200, currentLocation: "WBAK HQ", destination: "Undecided", status: "At HQ" },
  ...
  { id: "wbak-uncertain-353", name: "Magnum lying leg curl", brand: "Magnum", category: "Other", tdmRef: "353", cost: 0, marketValue: 0, currentLocation: "WBAK HQ", destination: "Undecided", status: "At HQ", notes: "From Aug 2026 WBAK stock list, no value/notes recorded -- needs verification" },
  { id: "wbak-uncertain-357", name: "Magnum pulldown", brand: "Magnum", category: "Other", tdmRef: "357", cost: 0, marketValue: 0, currentLocation: "WBAK HQ", destination: "Undecided", status: "At HQ", notes: "From Aug 2026 WBAK stock list, no value/notes recorded -- needs verification" },
  ...
  { id: "unity5-ref356", name: "Magnum Biangular Chest Press", brand: "Magnum", category: "Chest", subcategory: "Presses", tdmRef: "356", cost: 0, marketValue: 3000, currentLocation: "WBAK HQ", destination: "Unity 5", status: "At HQ" },
  { id: "unity5-ref352", name: "Magnum Leg Extension", brand: "Magnum", category: "Legs", subcategory: "Leg Extensions", tdmRef: "352", cost: 0, marketValue: 1800, currentLocation: "WBAK HQ", destination: "Unity 5", status: "At HQ" },
  { id: "unity5-ref150", name: "Bodymasters 410 Bicep", brand: "Bodymasters", category: "Arms", subcategory: "Biceps", tdmRef: "150", cost: 0, marketValue: 3000, currentLocation: "WBAK HQ", destination: "Unity 5", status: "At HQ" },

  // ===== UNITY 5 ASSET REGISTER — remaining items with no prior record =====
  { id: "unity5-magnum-e-series-incline-chest", name: "Magnum E Series Incline Chest", brand: "Magnum", category: "Chest", subcategory: "Presses", cost: 0, marketValue: 1500, currentLocation: "WBAK HQ", destination: "Unity 5", status: "At HQ" },
